...
/**
 * init_binaryLifting(root = 0); root has parent "-1"
 * 
 * O(logN) 
 * attarch(a, b) - attaches a as achild of b
 * 
 * O(logN)
 * ancestorKth(u, k) -> returns kth ancestor of u, -1 if don't exist;
 * 
 * O(logN)
 * get_lca(a, b) -> Least Common Ancestor of a and b
 * 
 * O(logN)
 * get_dist(a, b) -> distance of a and b through lac(a, b)
 * 
 * */